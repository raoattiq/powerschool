...
class Powerschool
  ...
  get :school_students, :ws, '/school/:school_id/student?expansions=addresses,phones,contact,contact_info,school_enrollment&extensions=u_studentsuserfields,studentcorefields'
